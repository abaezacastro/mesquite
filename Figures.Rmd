...
load("data/mean_annual_temperature_1950-2000_predictor1_object")
Tmean_m=Tmean_m/10

load("data/Total_annual_rainfall_1950-2000_predictor2_object") #PPT_m

load("data/mean_annual_temperature_1900-1950_predictor1_object")
Tmean_historic_m=Tmean_historic_m/10
load("data/annual_total_rainfall_raster_historico")#PPT_m_H
total_annual_rainfall_h=PPT_m_H

#load climate scenarios from "future_scenarios.Rmd"
load("data/Climate_Scenario_4")
...
load("data/prosopis_glandulosa_BIOCLIM_H_outputs")#bioclim_hist_outputs
load("data/prosopis_glandulosa_GAM_H_outputs") #gam_hist_outputs


load("data/prosopis_glandulosa_GLM_C_outputs") # glm_current_outputs
load("data/prosopis_glandulosa_BIOCLIM_C_outputs") # bioclim_curr_outputs
load("data/prosopis_glandulosa_GAM_C_outputs") #gam_curr_outputs


#future
load("data/GLM_scenario_85")#GLM_F  P2100
load("data/BIOCLIM_scenario_85")#BIOCLIM_F P2100
load("data/GAM_F_scenario_85")#GAM_F  P2100
